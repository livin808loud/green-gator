...
assert.strictEqual(sept.length, 5, 'expected 5 September loads, got ' + sept.length);
...
assert.strictEqual(gross, 3750, 'September factored gross should be 1750+600+800+600, got ' + gross);
