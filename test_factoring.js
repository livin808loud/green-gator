...
assert.strictEqual(sept.length, 10, 'expected 10 September loads, got ' + sept.length);
...
assert.strictEqual(gross, 4850, 'September factored gross should be 1750+600+800+600+150+950, got ' + gross);
